 ...
 */
@Embeddable
public class CourseOfferingPK implements Serializable {
    ...
    public CourseOfferingPK() {
    }

    public CourseOfferingPK(String crn, String department, String courseNumber) {
        this.crn = crn;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CourseOfferingPK)) {
            return false;
        }
        CourseOfferingPK other = (CourseOfferingPK) object;
    ...
    public String toString() {
        return "edu.corgi.uco.entity.CourseOfferingPK[ crn=" + crn + ", department=" + department + ", courseNumber=" + courseNumber + " ]";
    }
